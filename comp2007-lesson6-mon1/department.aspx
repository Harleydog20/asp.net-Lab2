<%@ Page Title="Department Details" Language="C#" MasterPageFile="~/monday.Master" AutoEventWireup="true" CodeBehind="department.aspx.cs" Inherits="comp2007_lesson6_mon1.department" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:TextBox ID="txtName" runat="server" required="true" MaxLength="50"></asp:TextBox>
    </div>
    <div class="form-group">
